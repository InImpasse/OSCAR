...
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_OSCAR_Q2 = 0.015f;
...
constexpr float MAX_DOT_PRODUCT_ERROR_OSCAR_Q2 = 0.50f;
    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_Q2_0    ? MAX_QUANTIZATION_TOTAL_ERROR_OSCAR_Q2 :
            ...
            const float max_allowed_error = type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                                          ...
                                          : type == GGML_TYPE_Q2_0
                                          ? MAX_DOT_PRODUCT_ERROR_OSCAR_Q2
                                          : type == GGML_TYPE_Q1_0
