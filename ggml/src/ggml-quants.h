...
GGML_API void quantize_row_oscar2_kv_ref(const float * GGML_RESTRICT x, block_oscar2_kv * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_oscar2_kv(const block_oscar2_kv * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
